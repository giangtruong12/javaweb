...
<!-- Site Icons -->
<link rel="shortcut icon" href="/TheWayShop/static/client/images/favicon.ico" type="image/x-icon">
<link rel="apple-touch-icon" href="/TheWayShop/static/images/apple-touch-icon.png">
...
<body>
							...
							<tbody>
								<tr>
									<td class="thumbnail-img"><a href="#"> <img
											class="img-fluid" src="/TheWayShop/static/client/images/img-pro-01.jpg" alt="" />
									</a></td>
								...
								<tr>
									<td class="thumbnail-img"><a href="#"> <img
											class="img-fluid" src="/TheWayShop/static/client/images/img-pro-02.jpg" alt="" />
									</a></td>
									<td class="name-pr"><a href="#"> Lorem ipsum dolor sit
											amet </a></td>
									<td class="price-pr">
								...
								<tr>
									<td class="thumbnail-img"><a href="#"> <img
											class="img-fluid" src="/TheWayShop/static/client/images/img-pro-03.jpg" alt="" />
									</a></td>
									<td class="name-pr"><a href="#"> Lorem ipsum dolor sit
											amet </a></td>
									<td class="price-pr">
	...
	<!-- ALL JS FILES -->
	<script src="/TheWayShop/static/js/jquery-3.2.1.min.js"></script>
	<script src="/TheWayShop/static/js/popper.min.js"></script>
	<script src="/TheWayShop/static/js/bootstrap.min.js"></script>
	<!-- ALL PLUGINS -->

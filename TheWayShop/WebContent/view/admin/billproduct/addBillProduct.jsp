...
<form action="/TheWayShop/admin/bill-product/add" method="post">
<div class="form-group">
<label>Bill ID</label>
<input type="text" name="billid" readonly="readonly" value="${bill.id }">
</div>
...
<div>
<button type="submit" class="btn btn-primary">Add Bill Product</button>
</div>
</form>
